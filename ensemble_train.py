...
print(f'python bert_train.py -bs {bs} -lr 5e-5 -lr_emb 5e-6 -e {EPOCHS} -wdbr {WANDB_TRIAL_NAME} -model bert_attn --base bert-large-cased --save_model True')
os.system(f'python bert_train.py -bs {bs} -lr 5e-5 -lr_emb 5e-6 -e {EPOCHS}  -wdbr {WANDB_TRIAL_NAME} -model bert_attn --base bert-large-cased --save_model True')
