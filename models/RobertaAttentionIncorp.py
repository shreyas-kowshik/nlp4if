...
class RobertaAttentionIncorp(nn.Module):
    def __init__(self, incorp_dim, freeze_bert_params=False, dropout_prob=0.1, num_heads=3, base='roberta-base'):
      print("RobertaAttentionIncorp Being Used!\n\n\n")

      super(RobertaAttentionIncorp, self).__init__()
      ...
      # Penultimate layers
      self.out1_1 = LinearBlock(self.num_heads * 256, 256)
      self.out2_1 = LinearBlock(self.num_heads * 256, 256)
      self.out3_1 = LinearBlock(self.num_heads * 256, 256)
      self.out4_1 = LinearBlock(self.num_heads * 256, 256)
      self.out5_1 = LinearBlock(self.num_heads * 256, 256)
      self.out6_1 = LinearBlock(self.num_heads * 256, 256)
      self.out7_1 = LinearBlock(self.num_heads * 256, 256)

      self.out1_2 = LinearBlock(256, 64)
      self.out2_2 = LinearBlock(256, 64)
      self.out3_2 = LinearBlock(256, 64)
      self.out4_2 = LinearBlock(256, 64)
      self.out5_2 = LinearBlock(256, 64)
      self.out6_2 = LinearBlock(256, 64)
      self.out7_2 = LinearBlock(256, 64)

      self.out1_3 = nn.Linear(64 + self.incorp_dim, 2)
      self.out2_3 = nn.Linear(64 + self.incorp_dim, 3)
      self.out3_3 = nn.Linear(64 + self.incorp_dim, 3)
      self.out4_3 = nn.Linear(64 + self.incorp_dim, 3)
      self.out5_3 = nn.Linear(64 + self.incorp_dim, 3)
      self.out6_3 = nn.Linear(64 + self.incorp_dim, 2)
      self.out7_3 = nn.Linear(64 + self.incorp_dim, 2)
    ...
    def forward(self, sent_id, mask, inc_feats, get_embedding=False):
      ...
      out1 = self.out1_1(attn_out1)
      out2 = self.out2_1(attn_out2)
      out3 = self.out3_1(attn_out3)
      out4 = self.out4_1(attn_out4)
      out5 = self.out5_1(attn_out5)
      out6 = self.out6_1(attn_out6)
      out7 = self.out7_1(attn_out7)

      out1 = self.out1_2(out1)
      out2 = self.out2_2(out2)
      out3 = self.out3_2(out3)
      out4 = self.out4_2(out4)
      out5 = self.out5_2(out5)
      out6 = self.out6_2(out6)
      out7 = self.out7_2(out7)

      out1 = torch.cat([out1, inc_feats], 1)
      out2 = torch.cat([out2, inc_feats], 1)
      out3 = torch.cat([out3, inc_feats], 1)
      out4 = torch.cat([out4, inc_feats], 1)
      out5 = torch.cat([out5, inc_feats], 1)
      out6 = torch.cat([out6, inc_feats], 1)
      out7 = torch.cat([out7, inc_feats], 1)

      out1 = self.out1_3(out1)
      out2 = self.out2_3(out2)
      out3 = self.out3_3(out3)
      out4 = self.out4_3(out4)
      out5 = self.out5_3(out5)
      out6 = self.out6_3(out6)
      out7 = self.out7_3(out7)
