...
parser.add_argument("-dtp", "--data_train_path", type=str, default="data/bulgarian/v1/",
                    help="Expects a path to training folder")
parser.add_argument("-ddp", "--data_dev_path", type=str, default="data/bulgarian/v1/",
                    help="Expects a path to dev folder")
parser.add_argument("-model", "--model_to_use", type=str, default="bert_train_emb",
                    help="Which model to use")
parser.add_argument("-bbase", "--base", type=str, default="bert-base-multilingual-cased",
                    help="Which bert base model to use")
parser.add_argument("-msl", "--max_seq_len", type=int, default=60, # Based on checking the values
...
parser.add_argument("-lr_emb", "--learning_rate_embeddings", type=float, default=5e-6,
